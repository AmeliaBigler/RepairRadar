    ...
    try {
        ...
        let mailGenerator = new mailgen({
            ...
            product: {
                ...
                link: "https://repairradar.herokuapp.com"
            }
        });
            ...
            body: {
                ...
                action: {
                    ...
                    button: {
                        ...
                        link: "https://repairradar.herokuapp.com/dashboard"
                    }
                },
...
const winnerBid = async (req, res, table, ticketData) => {
    try {
        ...
        const mechanicData = await table.findByPk(ticketData.winner);
        ...
        let response = {
            body: {
                ...
                intro: "You've Won!",
                action: {
                    instructions: "One of the tickets you bid on has declared you the winner! Click below to start messaging the user!",
                    button: {
                        text: "Go to messages",
                        //TODO: Add link to dashboard on the deployed site
                        link: "https://repairradar.herokuapp.com/messages"
                    }
                },
                outro: "This is an autogenerated email from an unmonitored email inbox. Please do not reply to this email"
            }
